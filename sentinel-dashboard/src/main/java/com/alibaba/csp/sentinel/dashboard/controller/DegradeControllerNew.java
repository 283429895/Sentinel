...
public class DegradeControllerNew {

    private final Logger logger = LoggerFactory.getLogger(DegradeControllerNew.class);
    ...
    public Result<DegradeRuleEntity> updateIfNotNull(Long id, String app, String limitApp, String resource,
        ...
        try {
            entity = repository.save(entity);
            if (entity == null) {
                return Result.ofFail(-1, "save degrade entity fail");
            }
            publishRules(entity.getApp());
        } catch (Throwable throwable) {
